...
def run_test_sum_of_digits():
    ...
    # ------------------------------------------------------------------
    # TOdoneDO: 2. Implement this TEST function, as follows:
    #
...
def run_test_digits_in_cube():
    ...
    # ------------------------------------------------------------------
    # TOdoneDO: 3. Implement this function.
    ...
    expected2 = 10
    answer2 = sum_of_digits(4**3)
    print('Test 2 expected:', expected2)
    print('         actual:', answer2)

    expected3 = 9
    answer3 = sum_of_digits(6**3)
    print('Test 3 expected:', expected3)
    print('         actual:', answer3)
...
def run_test_digits_in_power():
    ...
    # ------------------------------------------------------------------
    # TOdoneDO: 5. Implement this function.
...
def digits_in_power(n, k):
    ...
    """
    # ------------------------------------------------------------------
    # TOdoneDO: 6. Implement and test this function.
    #
    ####################################################################
    # IMPORTANT: CALL, as many times as needed,
    #    the    sum_of_digits    function that is DEFINED ABOVE.
...
def run_test_fancy_sums_of_digits():
    ...
    # ------------------------------------------------------------------
    # TOdoneDO: 7. Implement this function.
    ...
    expected = 10
    answer = sum_of_digits(sum_of_digits(10**1000) ** sum_of_digits(10**999))
...
def fancy_sums_of_digits(n):
    ...
    """
    # ------------------------------------------------------------------
    # TOdoneDO: 8. Implement and test this function.
    #
    ####################################################################
    # IMPORTANT: CALL, as many times as needed,
    #    the    sum_of_digits    function that is DEFINED ABOVE.
