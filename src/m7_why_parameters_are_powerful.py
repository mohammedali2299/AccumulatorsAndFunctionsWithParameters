...
"""  # TODdoneO: 1. PUT YOUR NAME IN THE ABOVE LINE.
...
def run_test_draw_circles():
    ...
    # ------------------------------------------------------------------
    # Students:
    #   Do NOT touch this function - it has no TdoneODO in it.
    # ------------------------------------------------------------------
    print()
    print('--------------------------------------------------')
...
def run_test_even_better_draw_circles():
    even_better_draw_circles(5, 300, 300, "blue")


def even_better_draw_circles(n, x, y, oc):
    window = rg.RoseWindow(400, 400)
    center = rg.Point(x, y)
